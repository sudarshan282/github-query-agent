...
function ChatWindow() {
  const [messages, setMessages] = useState([
    {
      type: "system",
      text: "REPO LOADED. ASK ME ANYTHING ABOUT THE CODEBASE."
    }
  ])
  ...
  const handleAsk = async () => {
    ...
    try {
      ...
      setMessages(prev => [...prev, {
        type: "error",
        text: error.response?.data?.detail || "ERROR. COULD NOT GET ANSWER."
      }])
    } finally {
      setLoading(false)
    }
    ...
    <div className="pixel-card mb-6">
      <div style={{
        ...
        <div className="flex items-center gap-3">
          ...
          <h2 style={{ color: "var(--cyan)", fontSize: "16px", margin: 0 }}>
            QUERY TERMINAL
          </h2>
        </div>
        <button
      ...
      <div style={{
        ...
        {loading && (
          <div style={{ color: "var(--cyan)", fontSize: "12px" }}>
            ◀ THINKING...
          </div>
        )}
        <div ref={bottomRef} />
